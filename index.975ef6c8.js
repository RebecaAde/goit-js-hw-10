...
var global = arguments[3];
global.Buffer = (0, _buffer.Buffer);
global.process = {
    env: {}
};
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_UzdHcRePlRtRy6sjJ3g82D8ZHbqfshTnCtER6K0VkXIS86cEYFypggoQHsiWwfUH";
...
breedSelect.addEventListener("change", async (e)=>{
    ...
    try {
        ...
        const cat = await (0, _catApiJs.fetchCatByBreed)(breedId);
        catInfo.innerHTML = `
...
},{"buffer":"fCgem","axios":"jo6P5","./cat-api.js":"d7YdZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
